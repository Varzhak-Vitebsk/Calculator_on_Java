...
final class LineGJ extends Line {

	public LineGJ(boolean use_main_color) {
	...
	public void draw(Graphics g, int x, int y, int length) {
		...
		//Middle line
		g.drawLine(x - Symbol.RIGHT_INDENT - length / 2
				, y + Symbol.TOP_INDENT + Symbol.CORNER_INDENT
				, x - Symbol.RIGHT_INDENT - length / 2
				, y + Symbol.TOP_INDENT + 2 * length - Symbol.CORNER_INDENT);
		//Inner line
		if(USE_INNER_LINE)
			g.drawLine(x - Symbol.RIGHT_INDENT - length / 2 + LINE_INDENT_X
				, y + Symbol.TOP_INDENT + Symbol.CORNER_INDENT + LINE_INDENT_Y
				, x - Symbol.RIGHT_INDENT - length / 2 + LINE_INDENT_X
